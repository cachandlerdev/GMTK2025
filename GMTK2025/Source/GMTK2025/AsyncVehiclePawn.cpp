...
// Sets default values
AAsyncVehiclePawn::AAsyncVehiclePawn()
{
...
#pragma endregion
	...
	MovementComponent = CreateDefaultSubobject<UAsyncVehicleMovementComponent>(TEXT("MovementComponent"));
...
void AAsyncVehiclePawn::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AAsyncVehiclePawn::Tick(float DeltaTime)
{
...
void AAsyncVehiclePawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

UStaticMeshComponent* AAsyncVehiclePawn::GetChassis_Implementation()
{
	return Chassis;
}

UArrowComponent* AAsyncVehiclePawn::GetFrontRightSuspension_Implementation()
{
	if (GEngine)
...
UArrowComponent* AAsyncVehiclePawn::GetFrontLeftSuspension_Implementation()
{
	return FrontLeftSuspension;
}

UArrowComponent* AAsyncVehiclePawn::GetBackRightSuspension_Implementation()
{
	return BackRightSuspension;
}

UArrowComponent* AAsyncVehiclePawn::GetBackLeftSuspension_Implementation()
{
