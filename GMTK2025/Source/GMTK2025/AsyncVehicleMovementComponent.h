...
#include "AsyncVehicleMovementComponent.generated.h"

class AAsyncVehiclePawn;

//Event called when physics change
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FAsyncPhysicsUpdatedEvent);

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class GMTK2025_API UAsyncVehicleMovementComponent : public UActorComponent
{
	GENERATED_BODY()

public:	
	UPROPERTY(BlueprintAssignable, Category = "Movement")
	FAsyncPhysicsUpdatedEvent OnAsyncPhysicsUpdated;

	// Sets default values for this component's properties
	UAsyncVehicleMovementComponent();
